...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      provider: 'v8',
      include: ['src/**/*.ts'],
      // index.ts and supabaseRepository.ts only wire the real Supabase client: not testable offline.
      exclude: ['src/index.ts', 'src/users/supabaseRepository.ts', 'src/types/**'],
